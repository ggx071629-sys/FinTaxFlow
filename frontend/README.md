...
## 欢迎页宽度回归修复（2026-09-20）

电脑端欢迎内容区保持最大 480px 居中、两侧灰底，手机端使用可视宽高。首帧占位、动画画布和点击区域边界一致。外层宿主仍覆盖全视口，并保留 html/body 与底层页面滚动锁定；不得为修复底部露出而移除内容区宽度限制。验收同时检查 320/375/390/480/844/1440 像素宽度、退场后解除锁定和登录页可操作。
